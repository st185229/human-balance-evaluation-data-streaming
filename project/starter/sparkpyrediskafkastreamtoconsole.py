...
# TO-DO: create a StructType for the Customer JSON that comes from Redis- before Spark 3.0.0, schema inference is not
# automatic
...
kafkaRedisDF = stediEventsDF.selectExpr("cast(value as string) value")
